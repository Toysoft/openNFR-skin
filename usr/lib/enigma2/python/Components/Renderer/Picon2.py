...
class Picon2(Renderer):
    searchPaths = ('/usr/share/enigma2/%s/', '/media/sde1/%s/', '/media/hdd/%s/', '/media/cf/%s/', '/media/mmc/%s/', '/media/sdd1/%s/', '/media/usb/%s/', '/media/usb1/%s/', '/media/ba/%s/', '/mnt/ba/%s/', '/media/sda/%s/', '/etc/%s/')
